...
namespace MSC.ConferenceMate.API.Controllers.CM
{
	public partial class UsersCMController : CMBaseApiController
	{
		...
		//partial void RunCustomLogicAfterInsert(ref entCM.User newDBItem, ref IRepositoryActionResult<entCM.User> result) {}

		//partial void RunCustomLogicAfterUpdatePatch(ref entCM.User updatedDBItem, ref IRepositoryActionResult<entCM.User> result) {}

		//partial void RunCustomLogicAfterUpdatePut(ref entCM.User updatedDBItem, ref IRepositoryActionResult<entCM.User> result) {}
